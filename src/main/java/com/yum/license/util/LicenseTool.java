...
public class LicenseTool {
	...
	// "D:/new-eclipse/neon-eclipse-workplace/licensius/example/template.dat";
	...
	public static void generateLicense(Properties features, OutputStream output, String privateKeyFile)
	...
	public void createLicense(Map<String, Object> map) throws Exception {
		if (!existsKeyFiles()) {
			generateKeys();
		}
		...
		if (map != null) {
			...
			properties.load(new FileInputStream(ResourceUtils.getFile("classpath:" + TEMPLATE_FILE)));
		}
